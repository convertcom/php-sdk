...
class Pagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets current_page
     *
     * @param int|null $current_page The current page number being displayed from the paginated set.
     *
     * @return self
     */
     ...
     * Sets items_count
     *
     * @param int|null $items_count The total number of items available across all pages for the current filter criteria.
     *
     * @return self
     */
     ...
     * Sets items_per_page
     *
     * @param int|null $items_per_page The number of items included in the current page of results (matches `results_per_page` from the request).
     *
     * @return self
     */
     ...
     * Sets pages_count
     *
     * @param int|null $pages_count The total number of pages available for the current filter criteria and `results_per_page` setting.
     *
     * @return self
     */
