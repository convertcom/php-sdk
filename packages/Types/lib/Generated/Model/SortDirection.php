 ...
 */
class SortDirection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SortDirection';
    ...
    {
        $this->setIfExists('sort_direction', $data ?? [], 'desc');
    }
    ...
    */
     ...
     * Sets sort_direction
     *
     * @param string|null $sort_direction The direction for sorting the list results, based on the `sort_by` field. - `asc`: Ascending order (e.g., A-Z, 1-10, oldest to newest). - `desc`: Descending order (e.g., Z-A, 10-1, newest to oldest). Defaults to `desc` (newest/highest first) if not specified.
     *
     * @return self
     */
