...
class DateRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets date_from
     *
     * @param \DateTime|null $date_from The start date for the range. The value must be in the format `YYYY-MM-DD`.
     *
     * @return self
     */
     ...
     * Sets date_to
     *
     * @param \DateTime|null $date_to The end date for the range. The value must be in the format `YYYY-MM-DD`.
     *
     * @return self
     */
