...
/**
 * TrackingScriptReleaseBase Class Doc Comment
 *
 * @category Class
 * @description Settings to identify which tracking script version will be applied to the project.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TrackingScriptReleaseBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrackingScriptReleaseBase';
    ...
    */
     ...
     *
     * @param string|null $current_version Current version of the tracking script bundle
     *
     * @return self
     */
     ...
     * Sets latest_version
     *
     * @param string|null $latest_version Latest available version of the tracking script bundle.
     *
     * @return self
     */
